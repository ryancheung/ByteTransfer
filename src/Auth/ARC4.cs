...
namespace ByteTransfer
{
    ...
    public class ARC4
    {
        ...
        public static void Apply(byte[] data, byte[] key, int startIndex = 0, int length = 0)
        {
            ...
            i = j = 0;
            Span<byte> result = stackalloc byte[dataLength];
            ...
            result.CopyTo(new Span<byte>(data, startIndex, dataLength));
        }
